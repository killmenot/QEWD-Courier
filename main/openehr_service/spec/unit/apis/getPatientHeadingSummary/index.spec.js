...
describe('openehr-service/apis/getPatientHeadingSummary', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../lib/commands', { GetPatientHeadingSummaryCommand });

    delete require.cache[require.resolve('@apis/getPatientHeadingSummary')];
    handler = require('@apis/getPatientHeadingSummary');
  });
