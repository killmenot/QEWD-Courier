...
describe('openehr-service/apis/getFeedsSummary', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../lib/commands', { GetFeedsSummaryCommand });

    delete require.cache[require.resolve('@apis/getFeedsSummary')];
    handler = require('@apis/getFeedsSummary');
  });
