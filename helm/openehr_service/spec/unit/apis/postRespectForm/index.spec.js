...
describe('openehr-service/apis/postRespectForm', () => {
  let args;
  let finished;

  let command;
  let PostRespectFormCommand;
  ...
  beforeEach(() => {
    ...
    PostRespectFormCommand = jasmine.createSpy().and.returnValue(command);
    mockery.registerMock('../../lib/commands', { PostRespectFormCommand });

    delete require.cache[require.resolve('@apis/postRespectForm')];
    handler = require('@apis/postRespectForm');
  });
