...
describe('openehr-service/apis/postPatientTop3Things', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    delete require.cache[require.resolve('@apis/postPatientTop3Things')];
    handler = require('@apis/postPatientTop3Things');
  });
