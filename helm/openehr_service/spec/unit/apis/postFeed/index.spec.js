...
describe('openehr-service/apis/postFeed', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../lib/commands', { PostFeedCommand });

    delete require.cache[require.resolve('@apis/postFeed')];
    handler = require('@apis/postFeed');
  });
