...
describe('openehr-service/apis/getPatientHeadingSynopsis', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../lib/commands', { GetPatientHeadingSynopsisCommand });

    delete require.cache[require.resolve('@apis/getPatientHeadingSynopsis')];
    handler = require('@apis/getPatientHeadingSynopsis');
  });
