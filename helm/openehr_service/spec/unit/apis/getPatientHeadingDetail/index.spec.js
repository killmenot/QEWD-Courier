...
describe('openehr-service/apis/getPatientHeadingDetail', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../lib/commands', { GetPatientHeadingDetailCommand });

    delete require.cache[require.resolve('@apis/getPatientHeadingDetail')];
    handler = require('@apis/getPatientHeadingDetail');
  });
