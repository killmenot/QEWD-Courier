...
describe('openehr-service/apis/getFeedDetail', () => {
  let args;
  let finished;
  ...
  beforeEach(() => {
    ...
    mockery.registerMock('../../lib/commands', { GetFeedDetailCommand });

    delete require.cache[require.resolve('@apis/getFeedDetail')];
    handler = require('@apis/getFeedDetail');
  });
