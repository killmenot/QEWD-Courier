...
const { GetDiscoveryPatientHeadingCommand } = require('@lib/commands');
const { Role } = require('@lib/shared/enums');
const { BadRequestError } = require('@lib/errors');

describe('discovery-service/lib/commands/getDiscoveryPatientHeading', () => {
  let ctx;
  let session;
  ...
  it('should throw patientId is not valid error', async () => {
    ...
    const command = new GetDiscoveryPatientHeadingCommand(ctx, session);
